...
import { Upload, FileText, Play, FileCheck, Trash2 } from 'lucide-react';
      ...
      <div className="bg-cardbg border border-borderDark rounded-xl p-6 shadow-md flex-1 flex flex-col min-h-0">
        ...
        <div className="flex-1 overflow-y-auto pr-1 flex flex-col gap-3">
          {documents.length === 0 ? (
            ...
            documents.map(doc => (
              <div key={doc.id} className="flex items-center justify-between p-3 rounded-lg bg-borderDark/20 border border-borderDark/40 gap-2">
